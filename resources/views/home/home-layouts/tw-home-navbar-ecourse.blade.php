    ...
    <div class="md:max-w-main mx-auto flex max-w-[90%] flex-wrap items-center justify-between pt-8 md:pt-[45px]">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
            <ul
                ...
                @else
                    <a href="/login"
                        class="mb-2 me-2 rounded-lg bg-yellow-400 px-4 py-2 text-base font-medium hover:bg-blue-800 focus:outline-none focus:ring-1 focus:ring-orange-700 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</a>
                </ul>
            @endauth
        </div>
    </div>
    ...
    <div class="md:max-w-main mx-auto flex max-w-[90%] flex-wrap items-center justify-between">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown1">
            <ul
                ...
                @else
                    <a href="/login"
                        class="me-2 rounded-lg bg-yellow-400 px-4 py-2 text-base font-medium text-black hover:bg-blue-800 focus:outline-none focus:ring-1 focus:ring-orange-700 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</a>
                </ul>
            @endauth
        </div>
    </div>
