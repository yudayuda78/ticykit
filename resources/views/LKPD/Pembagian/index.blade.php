<x-dashboard.app>
    <div class="pb-6">
        ...
        <p class="pt-2 text-sm text-gray-500">Soal-soal tentang konsep dan penerapan operasi Pembagian</p>
    </div>
    <form class="rounded-2xl border border-gray-200">
        <div class="px-7 py-5">
            <h3 class="font-bold">Informasi Lembar Kerja</h3>
            <p class="text-sm text-gray-500">Ketikan informasi tentang LKPD operasi Pembagian yang akan dibuat</p>
        </div>
        <hr />
    ...
    <form method="POST" action="{{ route('LKPD.pembagianDownload') }}" style="display: none;">
        @csrf
    ...
    <script>
        ...
        document.getElementById('kirimBtn').addEventListener('click', function() {
            ...
            for (let i = 0; i < jumlahSoal; i++) {
                ...
                if (angkaPertama === 0) angkaPertama = 1;


                let faktor = [];
                for (let j = 1; j <= angkaPertama; j++) {
                    if (angkaPertama % j === 0) {
                        faktor.push(j);
                    }
                }
                ...
                let angkaKedua = faktor[Math.floor(Math.random() * faktor.length)];
        ...
        document.querySelector('.download').addEventListener('click', function() {
            ...
            document.querySelector('form[action="{{ route('LKPD.pembagianDownload') }}"]').submit();
        });
    </script>
</x-dashboard.app>
{{-- <!DOCTYPE html>
...
<body>
    ...
    <div class="mb-4">
        ...
        <input type="number" name="jumlahSoal" id="jumlahSoal" class="w-full p-2 mt-1 border border-gray-300 rounded-md" max="30" required>
    </div>
