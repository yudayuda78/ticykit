...
<body>
    ...
    <form method="POST" action="{{ route('LKPD.bilanganpecahanpembagianDownload') }}" style="display: none;">
        @csrf
    ...
    for (let i = 0; i < jumlahSoal; i++) {
        ...
        let hasilPembilang = pembilangsatu * penyebutdua;
        let hasilPenyebut = penyebutsatu * pembilangdua;
