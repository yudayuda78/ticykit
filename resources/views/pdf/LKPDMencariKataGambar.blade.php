...
<body>
    ...
    <div style="text-align: center; font-size: 25px; margin-top: 20px; margin-bottom: 20px; text-transform: capitalize;">
        <strong>{{ $judul }}</strong>
    </div>
    ...
    <table style="border-collapse: collapse; margin: 0; padding: 0;">
        @foreach($katagrid as $item)
            ...
            @endif
            <td style="padding: 0; margin: 0; padding-top:0.3rem; padding-bottom: 0.3rem; border: 1px solid #A3A3A3; text-align: center; text-transform: capitalize;">
                <p style="margin: 0; padding: 0; font-size: 14px;">{{ $item }}</p>
            </td>
    ...
    <p style="padding: 1rem 0; margin: 0; width: 100%; text-align: center; font-size: 20px;">Cari Kata Dari Gambar Dibawah Ini</p>
    <table style="padding: 0; margin: 0; border-collapse: collapse; width: 100%;">
        @foreach($soal as $item)
            ...
            <td style="padding: 0; margin: 0; padding-bottom: 0.5rem; padding-left: 0.3rem; text-align: left; width: 50%;">
                <img style="padding: 0; margin: 0; border-radius: 0.5rem; width: 7rem; height: 6rem; object-fit: cover;" src="{{ public_path('img/' . $item . '.webp') }}" alt="Img Soal" class="footer-logo">
            </td>
