...
use App\Models\LKPDBilanganPecahanPengurangan;
use Illuminate\Http\Request;

class LKPDBilanganPecahanPenguranganController extends Controller
{
    /**
    ...
    {
        return view('LKPD.BilanganPecahanPengurangan.index');
    }
    ...
    public function download(Request $request){
        ...
        $pdf = PDF::loadView('pdf.LKPDBilanganPecahanPengurangan', compact('judul', 'pembilangsatuArray', 'pembilangduaArray', 'penyebutsatuArray', 'penyebutduaArray', 'hasilPembilang', 'hasilPenyebut'));
        return $pdf->download('soal_bilanganpecahanpengurangan.pdf');
    }
}
